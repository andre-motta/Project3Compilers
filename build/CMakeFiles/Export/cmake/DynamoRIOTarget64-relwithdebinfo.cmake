...
# Import target "drcctlib" for configuration "RelWithDebInfo"
set_property(TARGET drcctlib APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drcctlib PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib64/release/libdrcctlib.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrcctlib.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcctlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcctlib "${_IMPORT_PREFIX}/ext/lib64/release/libdrcctlib.so" )

# Import target "drcctlib_static" for configuration "RelWithDebInfo"
set_property(TARGET drcctlib_static APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drcctlib_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib64/release/libdrcctlib_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcctlib_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcctlib_static "${_IMPORT_PREFIX}/ext/lib64/release/libdrcctlib_static.a" )
