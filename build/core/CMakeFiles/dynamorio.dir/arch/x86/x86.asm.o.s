# 1 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
# 1 "/home/alustos/Project3Compilers/build/core//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
# 72 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
# 1 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/../asm_defines.asm" 1
# 42 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/../asm_defines.asm"
# 1 "/home/alustos/Project3Compilers/build/configure.h" 1
# 43 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/../asm_defines.asm" 2
# 73 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm" 2
.text


# 1 "/home/alustos/Project3Compilers/dynamorio/core/unix/os_asm_defines.asm" 1
# 77 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm" 2

# 1 "/home/alustos/Project3Compilers/dynamorio/core/unix/include/syscall.h" 1
# 22 "/home/alustos/Project3Compilers/dynamorio/core/unix/include/syscall.h"
# 1 "/home/alustos/Project3Compilers/dynamorio/core/unix/include/syscall_linux_x86.h" 1
# 23 "/home/alustos/Project3Compilers/dynamorio/core/unix/include/syscall.h" 2
# 79 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm" 2
# 119 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
# 1 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86_asm_defines.asm" 1
# 120 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm" 2
# 148 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
# 241 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global get_pic_xdi 
.hidden get_pic_xdi 
...
# 254 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global call_switch_stack 
.hidden call_switch_stack 
.type call_switch_stack, %function
call_switch_stack:
# 266 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        lea rsp, [-5*8 + rsp]
...
# 332 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global dr_call_on_clean_stack 
.type dr_call_on_clean_stack, %function
dr_call_on_clean_stack:
# 352 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        lea rsp, [-5*8 + rsp]
        ...
        push rbx
        push rbp
# 382 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        mov rbx, rax
        mov rbp, rsp
...
# 442 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 545 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global cleanup_and_terminate 
.hidden cleanup_and_terminate 
.type cleanup_and_terminate, %function
cleanup_and_terminate:
# 556 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        lea rsp, [-5*8 + rsp]
        ...
        mov [3*8 + rbp], rdx
        mov [4*8 + rbp], rcx
# 585 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
cat_spin:
        ...
        jmp cat_spin
cat_have_lock:
# 649 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        mov rsi, [2*8 + rbp]
        pop rax
        pop rcx
...
# 679 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
 ...
 call dynamo_thread_stack_free_and_exit 
        ...
        pop rdi
        pop rsi
# 730 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        mov dword ptr [rip + initstack_mutex], 0
# 739 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
# 756 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 795 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 843 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
       .align 0 
...
# 1132 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 1149 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global _start 
.hidden _start 
...
reloaded_xfer:
        ...
        mov rsi, rdi
        mov rdi, rsp
# 1178 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        
 call privload_early_inject 

        jmp unexpected_return
       
# 1190 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
dynamorio_sigreturn:
        ...
        mov r10, rcx
        syscall
# 1234 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        jmp unexpected_return
...
dynamorio_sys_exit:
# 1283 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        mov edi, 0
        mov eax, 60
        mov r10, rcx
        syscall
# 1296 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
dynamorio_condvar_wake_and_jmp:
        ...
        syscall
        jmp r12
# 1370 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
dynamorio_sys_exit_group:
        ...
        mov r10, rcx
        syscall
# 1403 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        jmp unexpected_return
       
# 1431 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 1469 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
       
# 1565 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
dynamorio_clone:
        ...
        mov rax, 56
        syscall
# 1595 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        cmp rax, 0
...
# 1674 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 1745 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
# 1779 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global dr_try_start 
...
# 1866 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
.global atomic_swap 
.hidden atomic_swap 
...
# 2214 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
get_ymm_caller_saved:
        mov rax, rdi
# 2261 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .byte 0xc5 
 .byte 0xfe 
 .byte 0x7f 
 .byte 0x00 
...
# 2285 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .byte 0xc5 
 .byte 0x7e 
 .byte 0x7f 
 .byte 0x80 
...
get_zmm_caller_saved:
        mov rax, rdi
# 2321 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .byte 0x62 
 .byte 0xf1 
 .byte 0xfe 
 .byte 0x48 
...
# 2355 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .byte 0x62 
 .byte 0x71 
 .byte 0xfe 
 .byte 0x48 
...
get_opmask_caller_saved:
        mov rax, rdi
# 2401 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .byte 0xc5 
 .byte 0xf8 
 .byte 0x91 
 .byte 0x00 
...
# 2427 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
...
# 2452 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
        .align 0 
...
_dynamorio_runtime_resolve:
 ...
 call dynamorio_dl_fixup 
        ...
        add rsp, 16
        jmp r11
# 2553 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
       
# 2708 "/home/alustos/Project3Compilers/dynamorio/core/arch/x86/x86.asm"
